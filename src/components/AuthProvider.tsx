...
export const translations: Record<string, { id: string; en: string }> = {
  ...
  "feat1.item1.title": { id: "SfM Global GLOMAP & COLMAP", en: "GLOMAP & COLMAP Global SfM" },
  "feat1.item1.desc": {
    id: "Estimasi pose kamera global dan triangulasi multi-sudut pandang deterministik berlisensi komersial BSD-3 tanpa penanda fisik.",
    en: "Deterministic global camera pose estimation and multi-view correspondence under a fully permissive commercial BSD-3 license without markers.",
  },
  "feat1.item2.title": { id: "Optimasi GPU gsplat (Nerfstudio)", en: "gsplat GPU Neural Optimization" },
  "feat1.item2.desc": {
    id: "Kernel CUDA clean-room dari UC Berkeley / Nerfstudio (Apache 2.0) mengoptimasi jutaan ellipsoida Gaussian 3D fotorealistik di GPU cloud A10G.",
    en: "Clean-room CUDA kernels from Nerfstudio/UC Berkeley (Apache 2.0) optimize millions of photorealistic 3D Gaussian ellipsoids on Cloud A10G GPUs.",
  },
  "feat1.item3.title": { id: "Isolasi Permukaan RANSAC & DBH", en: "RANSAC Ground-Isolation & DBH" },
  "feat1.item3.desc": {
    id: "Ekstraksi bidang tanah otomatis memisahkan lereng kontur hutan, mengisolasi batang pohon, dan memotong DBH silindris pada 1,30m.",
    en: "Automated plane extraction isolates forest terrain slope, segments trunk point clouds, and slices cylindrical DBH at 1.30m.",
  },
  ...
  "feat1.node2.title": { id: "GLOMAP SfM & RANSAC DBH 1.30m", en: "GLOMAP SfM & 1.30m RANSAC DBH" },
  "feat1.node2.sub": { id: "Pengepasan silinder pada 1,30m · Toleransi ±1,5 cm", en: "Cylinder fitting at 1.30m · ±1.5 cm tolerance" },
  "feat1.node2.badge": { id: "TEROPTIMASI", en: "OPTIMIZED" },
  "feat1.node3.title": { id: "3D Gaussian Splatting (gsplat / .ksplat)", en: "3D Gaussian Splatting (gsplat / .ksplat)" },
